...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (!empty($vaccine_name)) {
        if (addVaccine($vaccine_name, $description)) {
            header("Location: vaccines.php?success=1&msg=" . urlencode("Thêm vaccine thành công!"));
            exit;
        } else {
            header("Location: vaccines.php?error=1&msg=" . urlencode("Thêm vaccine thất bại!"));
            exit;
        }
    } else {
...
<head>
    ...
    <title>Thêm vaccine - Spa Thú Cưng Min Min</title>
            ...
            <div class="form-container">
                ...
                <form action="" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" id="vaccine_name" name="vaccine_name" placeholder="Nhập tên vaccine" required>
                    </div>
                    <div class="form-group">
