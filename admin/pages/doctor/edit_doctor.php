            ...
            <div class="form-container">
                ...
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="phone" name="phone" placeholder="Nhập số điện thoại" value="<?php echo htmlspecialchars($doctor['doctor_phone_number']); ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="identity_card">Thẻ căn cước</label>
                        <input type="number" id="identity_card" name="identity_card" placeholder="Nhập thẻ căn cước" value="<?php echo htmlspecialchars($doctor['doctor_identity_card']); ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="note" name="note" rows="3" placeholder="Nhập ghi chú (nếu có)..."><?php echo htmlspecialchars($doctor['doctor_note']); ?></textarea>
                    </div>
